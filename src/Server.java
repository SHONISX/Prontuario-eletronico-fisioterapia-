            ...
            try {
                ...
                if ("GET".equalsIgnoreCase(method)) {
                    ...
                    for (int i = 0; i < lista.size(); i++) {
                        ...
                        json.append("{")
                                .append("\"id\":").append(p.getIdPaciente()).append(",")
                                .append("\"nome\":\"").append(escapeJson(p.getNome())).append("\",")
                                .append("\"idade\":").append(p.getIdade()).append(",")
                                .append("\"diagnostico\":\"").append(escapeJson(p.getDiagnostico())).append("\"")
                                .append("}");
                ...
                if ("POST".equalsIgnoreCase(method)) {
                    ...
                    boolean ok = pacienteDAO.inserir(p);
                    sendResponse(exchange, ok ? "OK" : "ERRO");
                    return;
                }
        ...
        server.createContext("/evolucao", exchange -> {
            ...
            try {
                ...
                if ("POST".equalsIgnoreCase(method)) {
                    ...
                    evolucao.setIdPaciente(Integer.parseInt(extract(body, "idPaciente")));
                    evolucao.setIdUsuario(Integer.parseInt(extract(body, "idUsuario")));
                    evolucao.setDescricao(extract(body, "descricao"));
                ...
                if ("GET".equalsIgnoreCase(method)
                    ...
                    int idPaciente = Integer.parseInt(
                            query.substring(query.indexOf("idPaciente=") + 11)
                    );

                    List<Evolucao> lista = evolucaoDAO.listarPorPaciente(idPaciente);
                    StringBuilder json = new StringBuilder("[");
                    ...
                    for (int i = 0; i < lista.size(); i++) {
                        ...
                        json.append("{")
                                .append("\"idEvolucao\":").append(e.getIdEvolucao()).append(",")
                                .append("\"idPaciente\":").append(e.getIdPaciente()).append(",")
                                .append("\"idUsuario\":").append(e.getIdUsuario()).append(",")
                                .append("\"nomeUsuario\":\"").append(escapeJson(e.getNomeUsuario())).append("\",")
                                .append("\"descricao\":\"").append(escapeJson(e.getDescricao())).append("\",")
                                .append("\"data\":\"")
                                .append(e.getData() != null ? e.getData().toString() : "")
                                .append("\"")
                                .append("}");
        ...
        server.createContext("/comentario", exchange -> {
            ...
            try {
                ...
                if ("POST".equalsIgnoreCase(method)) {
                    ...
                    comentario.setIdEvolucao(Integer.parseInt(extract(body, "idEvolucao")));
                    comentario.setIdUsuario(Integer.parseInt(extract(body, "idUsuario")));
                    comentario.setComentario(extract(body, "comentario"));

                    boolean ok = comentarioDAO.inserir(comentario);
                    sendResponse(exchange, ok ? "OK" : "ERRO");
                    return;
                }
                ...
                if ("GET".equalsIgnoreCase(method)
                    ...
                    int idEvolucao = Integer.parseInt(
                            query.substring(query.indexOf("idEvolucao=") + 11)
                    );

                    List<Comentario> lista = comentarioDAO.listarPorEvolucao(idEvolucao);
                    StringBuilder json = new StringBuilder("[");
                    ...
                    for (int i = 0; i < lista.size(); i++) {
                        ...
                        json.append("{")
                                .append("\"idComentario\":").append(c.getIdComentario()).append(",")
                                .append("\"idEvolucao\":").append(c.getIdEvolucao()).append(",")
                                .append("\"nomeUsuario\":\"").append(escapeJson(c.getNomeUsuario())).append("\",")
                                .append("\"comentario\":\"").append(escapeJson(c.getComentario())).append("\",")
                                .append("\"data\":\"")
                                .append(c.getDataComentario() != null ? c.getDataComentario().toString() : "")
                                .append("\"")
                                .append("}");
